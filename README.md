...
Open dashpy.py either via cmd, powershell or whatever python editor you prefer. When you run the file, the terminal will return all outputs. Scroll through and look for an server address (should look like http://127.0.0.1:8050/). CTRL + click that link, or copy paste, to open in browser.
