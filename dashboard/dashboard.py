...
def _build_comparison_payload(
    ...
    for record in records:
        ...
        payload[ticker] = {
            ...
            "technical_status": record.get("Technical Status") or (metrics.get("technical_evidence_status") if isinstance(metrics, dict) else None),
    ...
    return [
        ...
        html.Div(
            [
                ...
                _overview_kpi("Technical Status", company.get("technical_status"), "RNS extraction state"),
            ],
